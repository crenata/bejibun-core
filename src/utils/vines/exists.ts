 ...
 * @param {ExtendOptions} options - The resolved `exists` options (table, column, withTrashed, nullable).
...
const exists = async (value: unknown, options: ExtendOptions, field: any): Promise<void> => {
    ...
    if (!row) field.report("The {{ field }} field doesn't exists", "exists", field);
};
